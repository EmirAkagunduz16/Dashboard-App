...
import personeOne from "../../assets/png/person1.png";
import personeTwo from "../../assets/png/person2.png";
import personeThree from "../../assets/png/person3.png";
        ...
        <div className={styles.expensesCard}>
          ...
          <section className={styles.moneyOverview}>
            ...
            <div className={styles.saveMoneyDiv}>
              ...
              <button type="button" className={styles.saveMoneyButton}>
                VIEW TIPS
              </button>
            </div>
          </section>
